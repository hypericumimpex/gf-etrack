<?php
/**
 * Plugin Name:       Hyp Forms Event Tracking
 * Plugin URI:        https://github.com/hypericumimpex/gf-etrack/
 * Description:       Event Tracking pt. Formularele utilizând Google Analytics, Managerul de etichete sau Matomo (fostul Piwik).
 * Version:           2.3.5
 * Author:            Romeo C.
